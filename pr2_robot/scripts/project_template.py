...
def pr2_mover(object_list):
    ...
    # Get/Read parameters
    pickplace_list_param = rospy.get_param('/object_list')
    ...
    dict_list = []
    for i in range(len(pickplace_list_param)):
        object_name = String()
        object_name.data = pickplace_list_param[i]['name']
        pick_pose = Pose()
        place_pose = Pose()
        arm_name = String()
        ...
        for j, label in enumerate(labels):
            if label == pickplace_list_param[i]['name']:
                ...
                pickplace_group = pickplace_list_param[i]['group']
                if pickplace_group == 'green':
